                     ...
                     <div class="row-fluid">
                        ...
                        <div  id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-pencil icon-large"></i> Edit Income</div>
                                <div class="muted pull-right"><a href="incomes.php"><i class="icon-arrow-left icon-large"></i> Back</a></div>
                            </div>
                            <div class="block-content collapse in">
						<?php
						$query = mysqli_query($conn,"select * from incomes where income_id = '$get_id'");
						$row = mysqli_fetch_array($query);
						?>
						<form id="edit_income" class="form-signin" method="post">
						<!-- span 4 -->
										<div class="span4">
										<input type="hidden" value="<?php echo $row['income_id']; ?>" class="input-block-level"  name="income_id" required>
										
									        <label>DETAILS:</label>
											<input type="text" class="input-block-level"  name="income" value="<?php echo $row['income']; ?>" required>
												<label>DATE:</label>
						...
						<div class="span4">
							...
							<dt><label>CHOOSE CATEGORY:</label></dt>
											...
											$cate = mysqli_query($conn,"select * from categories where isExpense= 0")or die('Error ');
										...
										$("#edit_income").submit(function(e){
											...
											$.ajax({
												...
												success: function(html){
													$.jGrowl("Income Successfully  Updated", { header: 'Income Updated' });
													
													window.location ='incomes.php';
												}
											});
										});
									});
