	...
	<center>
		<img src="./../images/logo.png" width="80px" height="100px" id="logo">
					...
					<li <?php if($campus=="dataEntry")echo "style='display:none'";?> ><a href="../orders.php"><i class="icon-chevron-left icon-large"></i><i class="icon-back icon-large"></i> Back</a></li>
						<li class="active"  <?php if($campus=="dataEntry")echo "style='display:none'";?> ><a href="dashboard.php"><i class="icon-chevron-right icon-large"></i><i class="icon-dashboard icon-large"></i> Dashboard</a></li>
						<li <?php if($campus=="dataEntry")echo "style='display:none'";?> ><a href="expenses.php"><i class="icon-chevron-right icon-large"></i><i class="icon-shopping-cart icon-large"></i> Expenses</a></li>
