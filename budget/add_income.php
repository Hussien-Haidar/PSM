                     ...
                     <div class="row-fluid">
                        ...
                        <div  id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-plus-sign icon-large"></i> Add Income</div>
                                <div class="muted pull-right"><a id="return" data-placement="left" title="Click to Return" href="incomes.php"><i class="icon-arrow-left icon-large"></i> Back</a></div>
						...
						<form id="add_income" class="form-signin" method="post">
						<!-- span 4 -->
										<div class="span4">
								
											<label>DETAILS:(تفاصيل)</label>
											<input type="text" class="input-block-level"  name="income" placeholder="Income" required>
											<label>DATE</label>
						...
						<dt><label>CHOOSE CATEGORY</label></dt>
											...
											$result = mysqli_query($conn,"select * from categories where isExpense= 0")or die('Error ');
				...
				$("#add_income").submit(function(e){
					...
					$.ajax({
						...
						success: function(html){
							$.jGrowl("Income Successfully  Added", { header: 'Income Added' });
