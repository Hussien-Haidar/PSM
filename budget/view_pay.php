            ...
            <div class="row-fluid">
                ...
                <div class="span9" id="">
                     <div class="row-fluid">
						...
						<div class="span5">
							<?php 
						$rider_id=$row['assigned_rider'];
						$q2 = mysqli_query($conn,"select * from riders where rider_id=$rider_id ");
		                $row2 = mysqli_fetch_array($q2);
		                $fname=$row2["firstname"];
		                $lname=$row2["lastname"];
						?>
						Assigned Rider: <strong><?php if($rider_id ==0)echo 'To be Assigned'; else echo $fname.' '.$lname; ?></strong><hr>
