                    ...
                    <div class="row-fluid">
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <?php
                                if (isset($_GET['role']) && $_GET['role'] == "pharmacist")
                                    $result = mysqli_query($con, "Select * from pharmacists where id = '$get_id'");
                                else
                                    $result = mysqli_query($con, "Select * from requests where id = '$get_id'");
                                ...
                                <div class="muted pull-left"><i style="color: lightseagreen;" class="icon-map-marker icon-large"></i><?php echo $full_name; ?> Loction</div>
